            ...
            <div ref={ref} className="keen-slider mt-10 pb-11">
                {
                    categories.map(cat => 
                        <a href={cat.slug} key={cat.id+cat.name}>
                            <div className="keen-slider__slide bg-pizza-700 hover:bg-pizza-600 transition-colors ease-in-out duration-300 text-white rounded-3xl shadow-lg shadow-slate-300">
                                <div>
                                    {cat.icon}
                                </div>
