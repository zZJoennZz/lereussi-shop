        ...
        <div className={styles.searchSection}>
            <div className={styles.searchSectionInner} style={{ background: `url(${sectionBg.src})`, backgroundSize: 'contain', backgroundPosition: 'bottom left', backgroundRepeat: 'no-repeat'}}>
                ...
                <div className={styles.searchInput}>
                    ...
                    <button className="inline rounded-full bg-gumbo hover:bg-pizza-600 transition-all ease-in-out duration-300 text-white p-4"><MagnifyingGlassIcon className="inline w-6 h-6" /></button>
                </div>
            </div>
        </div>
    )
