    ...
    <div className="border-t border-gray-300">
      <footer className="w-full overflow-hidden">
        <div className={styles.footerInfo}>
          <div className="mb-3 md:mb-0 col-span-12 md:col-span-4 lg:col-span-6 order-1 md:order-1">
            <div className="mb-4">
              <Image src={logo} priority className="w-1/2" alt="Le REUSSI Logo" />
            </div>
            <div className="mb-3 pr-2">
              <p className="text-justify text-sm text-slate-600">
                Started off as a hobby in family gatherings, Le Reussi is a quaint cakes and drinks cafe right along Banawe. After your fill of
                chinese food in this area, satisfy your belly with some desserts.
              </p>
            </div>
            <div className="flex">
        ...
        <div className="bg-pizza-700">
          <div className={styles.footerCredits}>
            <div className="mb-1">Le REUSSI &copy; 2023</div>
            <div className="text-xs">Powered by T1 Solutions</div>
          </div>
        </div>
      </footer>
    </div>
