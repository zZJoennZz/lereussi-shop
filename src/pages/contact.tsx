                            ...
                            <div>
                                ...
                                <form action="">
                                    <div className="mb-3">
                                        ...
                                        <div>
                                            <input type="text" placeholder="Hey! How can we help you?" className="w-full outline-none bg-slate-200 border border-slate-300 p-3 rounded-2xl" />
                                        </div>
                                    </div>
                                    <div className="mb-3">
                                        <div className="mb-1">
                                        ...
                                        <div>
                                            <input type="text" placeholder="Let us get back to you!" className="w-full outline-none bg-slate-200 border border-slate-300 p-3 rounded-2xl" />
                                        </div>
                                    </div>
                                    <div className="mb-3">
                                        <div className="mb-1">
                                        ...
                                        <div>
                                            <textarea placeholder="Tell us more!" className="w-full outline-none bg-slate-200 border border-slate-300 p-3 rounded-2xl"></textarea>
                                        </div>
                                    </div>
